<?php 
    ...
    if (isset($_POST['simpanData'])) {
        ...
        if (isset($_POST['id'])) {
            ...
            $stmt = $mysqli->prepare("UPDATE dokter SET alamat=?, no_hp=? WHERE id=?");
            $stmt->bind_param("ssi", $alamat, $no_hp, $id);
            $stmt->execute();
...
<main id="editDokter-page">
    <div class="container" style="margin-top: 5.5rem;">
        <div class="row">
            <h2 class="ps-0">Edit Dokter</h2>
            <div class="container">
                <form action="" method="POST" onsubmit="return(validate());">
                    ...
                    <div class="mb-3 w-25">
                        ...
                        <input disabled type="text" name="nama" class="form-control" required placeholder="Masukkan nama" value="<?php echo $nama ?>">
                    </div>
                    <div class="mb-3 w-25">
                        <label for="nip">NIP <span class="text-danger">*</span></label>
                        <input disabled type="text" name="nip" class="form-control" required placeholder="Masukkan NIP" value="<?php echo $nip ?>">
                    </div>
                    <!--<div class="mb-3 w-25">
                        ...
                        <select class="form-select" name="id_poli" aria-label="id_poli">
                            ...
                            <?php
                                ...
                                while ($data = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "<option disabled $selected value='" . $data['id'] . "'>" . $data['nama_poli'] . "</option>";
                                }
                            ?>
