...
if (isset($_POST['simpanData'])) {
    ...
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $sql = "UPDATE obat SET harga='$harga' WHERE id='$id'";
            ...
            <div class="container">
                <form action="" method="POST" onsubmit="return(validate());">
                    ...
                    <div class="mb-3 w-25">
                        ...
                        <input disabled type="text" name="nama_obat" class="form-control" required placeholder="Masukkan obat" value="<?php echo $nama_obat ?>">
                    </div>
                    <div class="mb-3 w-25">
                        <label for="kemasan">Kemasan <span class="text-danger">*</span></label>
                        <input disabled type="text" name="kemasan" class="form-control" required placeholder="Masukkan kemasan" value="<?php echo $kemasan ?>">
                    </div>
                    <div class="mb-3 w-25">
